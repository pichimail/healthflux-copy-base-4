...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
    { name: t('nav.home'), page: 'Dashboard', icon: LayoutDashboard },
    { name: t('nav.documents'), page: 'Documents', icon: FileText },
    { name: t('nav.vitals'), page: 'Vitals', icon: Activity },
    { name: t('nav.meds'), page: 'Medications', icon: Pill },
    { name: t('nav.symptoms'), page: 'SymptomChecker', icon: Stethoscope },
  ];
