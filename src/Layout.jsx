...
import {
  ...
  User, TestTube, Brain, Menu, X, AlertCircle, MoreVertical, Settings, Shield, LogOut, Stethoscope } from
'lucide-react';
...
export default function Layout({ children, currentPageName }) {
  ...
  { name: 'Symptoms', page: 'SymptomChecker', icon: Stethoscope }];
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F2] pb-20 md:pb-0">
      ...
      {/* Desktop Sidebar */}
      <aside className="bg-blue-100 rounded-[28px] hidden md:block fixed left-0 top-0 h-full w-64 border-r border-gray-200 z-40 overflow-y-auto">
        <div className="p-6">
