...
import {
  ...
  Plus, AlertCircle, CheckCircle, ArrowRight, Brain, Sparkles, MessageSquare, Bell } from
'lucide-react';
    ...
    <div className="px-3 sm:px-6 py-4 sm:py-6 pb-24 sm:pb-6">
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              onClick={() => setChatOpen(true)} className="bg-orange-100 text-[#0A0A0A] px-4 py-2 text-sm font-semibold rounded-2xl inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-[#8BA4EE] active-press shadow-lg h-11 sm:h-12">
      ...
      <div className="grid gap-3 sm:gap-4">
        ...
        <Card className="border-0 shadow-sm rounded-2xl">
          ...
          <CardContent className="bg-emerald-50 p-6 rounded-[20px]">
            {documents.length === 0 ?
