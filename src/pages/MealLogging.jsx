  ...
  return (
    <div className="px-3 sm:px-6 py-4 sm:py-6 pb-24 sm:pb-6">
      ...
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">AI-powered nutrition tracking</p>
      ...
      <Card className="border-0 card-shadow rounded-2xl sm:rounded-3xl mb-4">
        ...
        <CardContent className="p-3 sm:p-4">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 mt-2">AI will analyze nutrition instantly</p>
          </div>
        </CardContent>
      </Card>
